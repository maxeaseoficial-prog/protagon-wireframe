...
Os arquivos oficiais são `public/uploads/Design_sem_nome_2_.png` no hero, `public/uploads/Design_sem_nome.png` na apresentação do palestrante e `public/uploads/ChatGPT_Image_4_de_set._de_2026_12_56_34.png` na marca. O leão decorativo usa `public/uploads/1.png`. O cenário derivado da referência é `public/uploads/cuiaba-atmosphere.jpg`, com 1672 × 941 pixels e 394405 bytes (aproximadamente 385 KiB), reutilizado no hero e no local. O cenário é decorativo; retrato, marca e arte do evento têm textos alternativos.
...
| `max-width: 600px`, demais seções | Padding geral de 70 × 24 pixels; apresentação do palestrante inverte a ordem visual para texto seguido de retrato; três estatísticas em colunas; público vira lista de linhas numeradas; painel do local ocupa a largura total e tem mínimo de 540 pixels; cartões usam padding de 34 × 24 × 26 pixels.    |
